...
router.post('/register', async (req, res) => {
  try {
    ...
    const user = await User.create({
      ...
      referral_code: await getUniqueReferralCode(),
    ...
    if (referrer) {
      ...
      await Notification.create({
        ...
        message: `You earned a $${REFERRAL_BONUS} referral bonus! ${user.email} signed up with your referral code.`,
        type: 'referral_bonus',
        related_id: user._id.toString(),
      });
    }
